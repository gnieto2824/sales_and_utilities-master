...
class WizardSalesandUtilities(models.TransientModel):
    ...
    def _get_totals(self):
        for record in self:
            ...
            record.utility_percentage_total = record.cost_total_total and 100 * \
                record.utility_total / record.cost_total_total
            record.margin_total = record.price_total_total and 100 * \
                record.utility_total / record.price_total_total
